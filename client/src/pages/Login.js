    ...
    <div className="auth-page">
      ...
      <div className="auth-container" ref={cardRef}>
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle 250px at ${mousePos.x}px ${mousePos.y}px, rgba(34, 197, 94, 0.15), transparent)`,
          }}
        />
        ...
        <div className={`auth-card ${mounted ? 'mounted' : ''}`}>
          ...
          <div className="auth-header">
            ...
            <p className="auth-subtitle">Ready to crush your goals today?</p>
          </div>

          {/* Social Login Buttons - Coming Soon */}
          <div className="social-login">
            <button type="button" className="social-btn google coming-soon" aria-label="Login with Google (Coming Soon)" disabled title="Coming soon">
            ...
            <button type="button" className="social-btn github coming-soon" aria-label="Login with GitHub (Coming Soon)" disabled title="Coming soon">
          ...
          <form onSubmit={handleSubmit} className="auth-form" noValidate>
            ...
            <div className="form-options">
              ...
              <span className="forgot-link disabled" title="Coming soon">Forgot password?</span>
            </div>
