      ...
      <div className="auth-container" ref={cardRef}>
        ...
        <div className={`auth-card register-card ${mounted ? 'mounted' : ''}`}>
          ...
          <div className="social-login">
            <button type="button" className="social-btn google coming-soon" aria-label="Sign up with Google (Coming Soon)" disabled title="Coming soon">
            ...
            <button type="button" className="social-btn github coming-soon" aria-label="Sign up with GitHub (Coming Soon)" disabled title="Coming soon">
